...
<img width="800" height="624" alt="image" src="https://github.com/user-attachments/assets/fb17bcbb-6186-48b5-b9f0-47f3ab35b231" />
...
```mermaid
graph TD
    A[Hoodie One Stop] --> B[AI Career Navigator]
    B --> C[AI Trainer Tool]
    C --> D[AI Recruiter]
    D --> E[AI Career Assistant]
    A --> F[GPT Mentor]
    F --> G[Cyber Gauntlet Bot]
    E --> G
    G --> D
```
